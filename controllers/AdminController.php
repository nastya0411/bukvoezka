...
use app\models\BookCartSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdminController implements the CRUD actions for BookCart model.
 */
class AdminController extends Controller
{
    ...
    {
        $searchModel = new BookCartSearch();
    ...
    /**
     * Updates an existing BookCart model.
    ...
    /**
     * Deletes an existing BookCart model.
